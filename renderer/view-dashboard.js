...
// 首页
// ---------------------------------------------------------------
// 统计卡取色表：键 = 卡片语义名。此前 view-usage 借用其它模块的键名取色
// （渲染正确但语义含糊，易误改），现已补齐时间统计页自己的四个键。
const CHIP = { 待办: 'c1', 待办清单: 'c1', 打卡: 'c4', 习惯打卡: 'c4', 快捷入口: 'c2', 文件整理: 'c5', 便签: 'c3', 番茄钟: 'c2', 数据洞察: 'c5', 设置: 'c2', 今日已完成待办: 'c1', 今日打卡: 'c4', 累计便签: 'c5', 今日活跃时长: 'c2', 今日最常用应用: 'c1', 已记录天数: 'c5', 今日番茄: 'c4', 可用余额: 'c2', 今日消耗: 'c1', 近七天消耗: 'c4', 数据与刷新: 'c5' };
